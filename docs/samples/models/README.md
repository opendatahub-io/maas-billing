...
This directory contains `LLMInferenceService`s for deploying sample models. Please refer to the [deployment guide](https://github.com/opendatahub-io/maas-billing/blob/main/docs/content/quickstart.md) for more details on how to test the MaaS Platform with these models.

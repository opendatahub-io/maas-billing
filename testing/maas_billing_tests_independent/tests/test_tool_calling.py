...
#     """
#     Same as forced mode, but lets the model decide whether to call a tool.
#     Should not fail if the model decides NOT to call one.
#     """
...
#     # 3️⃣ Tool-calling test (auto)
#     payload = {
#         "model": model_name,
#         "messages": [
#             # {"role": "system", "content": "You may call tools when useful."},
#             {"role": "system", "content": "You are a weather assistant. When a user asks anything about weather, you MUST call the get_weather tool. Do not answer directly."},
#             {"role": "user", "content": "What's the weather in Boston, MA today? Use tools if needed."}
#         ],
#         "tools": tools_spec,
#         "tool_choice": "auto",
#         "temperature": 0,
...
#     # Soft check: it’s fine if the model decides not to call a tool
#     if not tool_calls:
#         pytest.skip("Model chose not to emit any tool_calls in auto mode")
